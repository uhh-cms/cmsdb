...
cpn.add_dataset(
    ...
    keys=[
        "/DYto2L-2Jets_MLL-10to50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8/Run3Summer23MiniAODv4_NanoAODv14UHH-130X_mcRun3_2023_realistic_v14_ext1-v4/NANOAODSIM",  # noqa
    ],
    n_files=149,
    n_events=203_211_782,
    aux={
        "merging_factors": {
            "nominal": 25,
        },
...
cpn.add_dataset(
    ...
    n_files=207,  # 1 skipped
    n_events=200_023_087,  # 68_950 skipped
    aux={
        "merging_factors": {
            "nominal": 15,
        },
...
cpn.add_dataset(
    ...
    n_files=361,  # 1 skipped
    n_events=400_733_495,  # 72_143 skipped
    aux={
        "merging_factors": {
            "nominal": 21,
        },
...
cpn.add_dataset(
    ...
    n_files=295,  # 1 skipped
    n_events=195_609_805,  # 35_287 skipped
    aux={
        "merging_factors": {
            "nominal": 15,
        },
