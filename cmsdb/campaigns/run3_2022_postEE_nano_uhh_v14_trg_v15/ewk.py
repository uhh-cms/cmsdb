...
cpn.add_dataset(
    ...
    keys=[
        "/DYto2L-2Jets_MLL-10to50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8/Run3Summer22EEMiniAODv4_NanoAODv14UHH-130X_mcRun3_2022_realistic_postEE_v6-v5/NANOAODSIM",  # noqa
    ],
    n_files=248,
    n_events=355_699_357,
    aux={
        "merging_factors": {
            "nominal": 27,
        },
