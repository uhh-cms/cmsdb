...
cpn.add_dataset(
    ...
    id=14260218,
    processes=[procs.dy_lep_m50_amcatnlo],
    keys=[
...
cpn.add_dataset(
    name="",
    id=14196293,
    processes=[procs.z_2nu_ht100to200],
    keys=[
...
cpn.add_dataset(
    name="wwz_amcatnlo_ext",
    id=14266674,
    processes=[procs.wwz_ext],
    keys=[
