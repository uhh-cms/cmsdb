...
"""
Top quark datasets for the 2023 data-taking campaign with datasets at NanoAOD tier in
...
[naseeba@lxplus717 scripts]$ python3 get_das_info.py -d /TbarBQ*/Run3Summer23NanoAODv12*/NANOAODSIM
[naseeba@lxplus717 scripts]$ python3 get_das_info.py -d /TWminustoLNu2Q*/Run3Summer23NanoAODv12*/NANOAODSIM
cpn.add_dataset(
    name="PLACEHOLDER",
    id=14819590,
    processes=[procs.PLACEHOLDER],
