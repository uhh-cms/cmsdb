...
campaign_run3_2023_preBPix_nano_uhh_v14 = Campaign(
    ...
    aux={
        ...
        "custom": {
            "name": "run3_2023_preBPix_nano_uhh_v14",
            "creator": "uhh",
            "location": "davs://dcache-cms-webdav-wan.desy.de:2880/pnfs/desy.de/cms/tier2/store/user/bwieders/nanogen_store/MergeNano/config_23pre_v14/prod2",  # noqa
...
import cmsdb.campaigns.run3_2023_preBPix_nano_uhh_v14.hh2bbvv  # noqa
