...
# SM sample
cpn.add_dataset(
    name="hhh_c3_0_d4_0_4b2tau_madgraph",
    id=14791536,
    processes=[procs.hhh_c3_0_d4_0_4b2tau],
    keys=[
...
cpn.add_dataset(
    name="hhh_c3_0_d4_99_4b2tau_madgraph",
    id=14804364,
    processes=[procs.hhh_c3_0_d4_99_4b2tau],
    keys=[
...
cpn.add_dataset(
    name="hhh_c3_0_d4_minus1_4b2tau_madgraph",
    id=14796291,
    processes=[procs.hhh_c3_0_d4_minus1_4b2tau],
    keys=[
...
cpn.add_dataset(
    name="hhh_c3_19_d4_19_4b2tau_madgraph",
    id=14805829,
    processes=[procs.hhh_c3_19_d4_19_4b2tau],
    keys=[
...
cpn.add_dataset(
    name="hhh_c3_1_d4_0_4b2tau_madgraph",
    id=14805285,
    processes=[procs.hhh_c3_1_d4_0_4b2tau],
    keys=[
...
cpn.add_dataset(
    name="hhh_c3_1_d4_2_4b2tau_madgraph",
    id=14797470,
    processes=[procs.hhh_c3_1_d4_2_4b2tau],
    keys=[
...
cpn.add_dataset(
    name="hhh_c3_2_d4_minus1_4b2tau_madgraph",
    id=14798802,
    processes=[procs.hhh_c3_2_d4_minus1_4b2tau],
    keys=[
...
cpn.add_dataset(
    name="hhh_c3_4_d4_9_4b2tau_madgraph",
    id=14885952,
    processes=[procs.hhh_c3_4_d4_9_4b2tau],
    keys=[
...
cpn.add_dataset(
    name="hhh_c3_minus1_d4_0_4b2tau_madgraph",
    id=14797875,
    processes=[procs.hhh_c3_minus1_d4_0_4b2tau],
    keys=[
...
cpn.add_dataset(
    name="hhh_c3_minus1_d4_minus1_4b2tau_madgraph",
    id=14794127,
    processes=[procs.hhh_c3_minus1_d4_minus1_4b2tau],
    keys=[
...
cpn.add_dataset(
    name="hhh_c3_minus1p5_d4_minus0p5_4b2tau_madgraph",
    id=14796572,
    processes=[procs.hhh_c3_minus1p5_d4_minus0p5_4b2tau],
    keys=[
